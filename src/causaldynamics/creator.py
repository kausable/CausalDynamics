...
from causaldynamics.plot import animate_3d_trajectories, plot_scm, plot_trajectories
...
def simulate_system(
    ...
    """
    Run the system simulation with optional interventions.

    This function simulates a dynamical system using either random systems or a specified
    system type. It can also perform interventions at a specified time point.
